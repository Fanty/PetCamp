...
- (BOOL)saveAuthorizeDataToKeychain{
	...
	BOOL accessTokenSaveOK = [SFHFKeychainUtils storeUsername:TCKeychainAccessToken andPassword:accessToken forServiceName:serviceName updateExisting:YES error:nil];
    BOOL openIdSaveOK = [SFHFKeychainUtils storeUsername:TCKeychainOpenId andPassword:openId forServiceName:serviceName updateExisting:YES error:nil];
    BOOL openKeySaveOK = [SFHFKeychainUtils storeUsername:TCKeychainOpenKey andPassword:openKey forServiceName:serviceName updateExisting:YES error:nil];
	BOOL expireTimeSaveOK = [SFHFKeychainUtils storeUsername:TCKeychainExpireTime andPassword:[NSString stringWithFormat:@"%lf", expireTime] forServiceName:serviceName updateExisting:YES error:nil];
    BOOL refreshTokenSaveOK = [SFHFKeychainUtils storeUsername:TCKeychainRefreshToken andPassword:refreshToken forServiceName:serviceName updateExisting:YES error:nil];
    BOOL nameSaveOK = [SFHFKeychainUtils storeUsername:TCKeychainName andPassword:name forServiceName:serviceName updateExisting:YES error:nil];
    return accessTokenSaveOK && openIdSaveOK && openKeySaveOK && expireTimeSaveOK && refreshTokenSaveOK && nameSaveOK;
}

- (void)readAuthorizeDataFromKeychain{
    NSString *serviceName = [[self urlSchemeString] stringByAppendingString:TCKeychainServiceNameSuffix];
    self.openId = [SFHFKeychainUtils getPasswordForUsername:TCKeychainOpenId andServiceName:serviceName error:nil];
    self.openKey = [SFHFKeychainUtils getPasswordForUsername:TCKeychainOpenKey andServiceName:serviceName error:nil];
    self.accessToken = [SFHFKeychainUtils getPasswordForUsername:TCKeychainAccessToken andServiceName:serviceName error:nil];
    self.expireTime = [[SFHFKeychainUtils getPasswordForUsername:TCKeychainExpireTime andServiceName:serviceName error:nil] doubleValue];
    self.refreshToken = [SFHFKeychainUtils getPasswordForUsername:TCKeychainRefreshToken andServiceName:serviceName error:nil];
    self.name = [SFHFKeychainUtils getPasswordForUsername:TCKeychainName andServiceName:serviceName error:nil];
...
- (BOOL)deleteAuthorizeDataInKeychain{
    ...
    NSString *serviceName = [[self urlSchemeString] stringByAppendingString:TCKeychainServiceNameSuffix];
	BOOL accessTokenDeleteOK = [SFHFKeychainUtils deleteItemForUsername:TCKeychainAccessToken andServiceName:serviceName error:nil];
	BOOL expireTimeDeleteOK = [SFHFKeychainUtils deleteItemForUsername:TCKeychainExpireTime andServiceName:serviceName error:nil];
    BOOL refreshTokenDeleteOK = [SFHFKeychainUtils deleteItemForUsername:TCKeychainRefreshToken andServiceName:serviceName error:nil];
    BOOL nameDeleteOK = [SFHFKeychainUtils deleteItemForUsername:TCKeychainName andServiceName:serviceName error:nil];
    BOOL openIdDeleteOK = [SFHFKeychainUtils deleteItemForUsername:TCKeychainOpenId andServiceName:serviceName error:nil];
    BOOL openKeyDeleteOK = [SFHFKeychainUtils deleteItemForUsername:TCKeychainOpenKey andServiceName:serviceName error:nil];
