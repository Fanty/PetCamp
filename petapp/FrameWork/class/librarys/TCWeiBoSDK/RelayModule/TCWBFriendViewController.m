...
- (void)dealloc{
    ...
    [arrFriend release];
    [arrIndexFriend release];
    [arrSearchFriend release];
    
    [arrMutualFriend release];
    [arrIntimateFriend release];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (bSearchFriend && [indexPath row] == 0) {
        ...
        NSMutableDictionary *dicFriend = [NSMutableDictionary dictionary];
...
- (UITableViewCell *)createFriendCell:(UITableView *)tableView identifier:(NSString *)strIdentifier indexPath:(NSIndexPath *)indexPath  data:(NSMutableDictionary *)dicItem {
    ...
    if (cell == nil) {
        ...
        cell = [[[UITableViewFriendCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:strIdentifier] autorelease];
    }
...
- (UITableViewCell *)createKeyCell:(UITableView *)tableView identifier:(NSString *)strIdentifier  data:(NSDictionary *)dicItem {
    ...
    if (cell == nil) {
        cell = [[[UITableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:strIdentifier] autorelease];
    }
