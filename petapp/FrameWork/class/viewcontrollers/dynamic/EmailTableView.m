...
@interface EmailTableView()<UITableViewDataSource,UITableViewDelegate>

-(void)loadData:(BOOL)loadMore;

@end

@implementation EmailTableView
...
-(void)tableView:(UITableView *)_tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    controller.pid=model.target_id;
...
-(void)loadData:(BOOL)loadMore{
    ...
    task=[[AppDelegate appDelegate].petNewsAndActivatyManager emailMessage:temp_pageOffset];
    [task setFinishBlock:^{
